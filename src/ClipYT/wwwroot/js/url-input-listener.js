...
class MediaPlatformSource {
    constructor(regex, logoUrl, showPlayer, showClipButtons, showQualitySelector, accentColorCode, accentColorDarkCode) {
        this.regex = regex;
        this.logoUrl = logoUrl;
        this.showPlayer = showPlayer;
        this.showClipButtons = showClipButtons;
        this.showQualitySelector = showQualitySelector;
    ...
    setUiMode() {
        ...
        if (this.showQualitySelector) {
            $("#quality-select-container").show();
        } else {
            $("#quality-select-container").hide();
        }
    }
}